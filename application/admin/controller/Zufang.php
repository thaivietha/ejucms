...
//            }
            ...
            if ($aid) {
                ...
                // 生成静态页面代码
                $this->success("操作成功!", url("Index/uphtml").'&aid='.$aid.'&tid='.$post['typeid'].'&controller=Zufang&action=add');
                exit;
            }
    ...
    public function edit()
    {
        ...
        if (IS_POST) {
            ...
            if ($r) {
                ...
                // 生成静态页面代码
                $this->success("操作成功!", url("Index/uphtml").'&aid='.$data['aid'].'&tid='.$typeid.'&controller=Zufang&action=edit');
                exit;
            }
