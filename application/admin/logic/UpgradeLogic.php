...
class UpgradeLogic extends Model
{
    ...
    function  __construct() {
        ...
        $tmp_str = 'L2luZGV4LnBocD9tPWFwaSZjPUNtc1NlcnZpY2UmYT1jaGVja1ZlcnNpb24mY21zX3R5cGU9MQ==';
    ...
    public function OneKeyUpgrade(){
        ...
        } else if (!empty($serviceVersionList['code']) && -4 == $serviceVersionList['code']) {
            return ['code' => -4, 'msg' => $serviceVersionList['msg']];
        }
        ...
        foreach ($serviceVersionList as $key => $val) {
            ...
            // 授权升级
            if (-1 == $val['is_allow_upgrade']) {
                return ['code' => -4, 'msg' => $val['is_upgrade_tips']];;
            }
    ...
    private  function UpgradeLog($to_key_num){
        ...
        $tmp_str = 'L2luZGV4LnBocD9tPWFwaSZjPUNtc1NlcnZpY2UmYT11cGdyYWRlTG9nJmNtc190eXBlPTEm';
