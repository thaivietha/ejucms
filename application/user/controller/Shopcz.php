...
class Shopcz extends Base
{
    ...
    public function index(){
        ...
        return $this->fetch('users/shopcz_index');
    }
    public function add(){
        ...
        if (IS_POST) {
            ...
            $newData = array(
                ...
                'status' =>  !empty($this->users['check_shopcz']) ? 0 : 1,
            );
            ...
            if ($aid) {
                ...
                // 生成静态页面代码
                $this->success("操作成功!", url("Shopcz/index"));
                exit;
            }
        ...
        return $this->fetch('users/shopcz_add');
    }
    public function edit(){
        ...
        return $this->fetch('users/shopcz_edit');
    }
