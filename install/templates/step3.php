...
<div class="wrap">
    ...
    <form id="J_install_form" action="index.php?step=4" method="post">
      ...
      <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="dbname" id="dbname" value="ejucms" class="input" onBlur="TestDbPwd(0)"><div id="J_install_tip_dbname"></div></td>
          </tr>
          <tr>
            <td class="tar">数据库表前缀</td>
            <td><input type="text" name="dbprefix" id="dbprefix" value="eju_" class="input" ><div id="J_install_tip_dbprefix"><span class="gray">推荐使用&nbsp;eju_</span></div></td>
          </tr>
        </table>
  ...
  function ajaxSubmit()
  {
      $.ajax({
          ...
          error:function() {
              layer.closeAll();
              layer.alert('未知错误，操作中断！', {icon: 5, title: false});
              return false;
          }
      });
  }
