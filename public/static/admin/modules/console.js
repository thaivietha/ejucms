  ...
  */
  ...
  layui.use('table', function(){
    ...
    table.render({
      ...
      ,url: layui.setter.base + 'json/console/top-search.js?v={$version}' //模拟接口
      ,page: false
      ,cols: [[
        {type: 'numbers', fixed: 'left'}
        ,{field: 'keywords', title: '关键词123', minWidth: 300, templet: '<div><a href="https://www.baidu.com/s?wd={{ d.keywords }}" target="_blank" class="layui-table-link">{{ d.keywords }}</div>'}
        ,{field: 'frequency', title: '搜索次数123', minWidth: 120, sort: true}
