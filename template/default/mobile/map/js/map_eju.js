...
var BMapApplication = {
    ...
    "makeInfoWindow" : function (key) {
        ...
        var html = '<a class="item" href="'+ _ite.arcurl+'">' +
            ...
            '<div class="favourable">'+_ite.sale_status_name+'</div>' +
            '</div>'+
            '<div class="item_address">'+_ite.address+'</div>'+
            '<div class="item_bot">'+_ite.manage_type_name_i+'</div>'+
            '<div class="item_price"><span>均   价：<label>'+_ite.average_price+'</label>' + _ite.price_units+'</span></div>' +
        '</div>'+
        '<div class="cl"></div>' +
        '</a>';
        ...
        //     '<span class="rexiao_1"></span><p class="all366C"><a target="_blank" href="'+_ite.arcurl+'">进入楼盘详情页>></a></p></div></div><div class="m2"></div></div></div>';
        // var opts = {
