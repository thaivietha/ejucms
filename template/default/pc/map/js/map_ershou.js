...
var BMapApplication = {
    ...
    "makeInfoWindow" : function (key) {
        ...
        var sContent = '<div class="t_box">' +
            ...
            '<ul><li><em>房源类型：</em>'+_ite.manage_type_name+'</li>' +
            '<li><em>价    格：</em>'+_ite.total_price+'万元</li>' +
            '<li><em>咨询热线：</em> <i>'+_ite.sale_phone+'</i></li><li><em>房源地址：</em> '+_ite.address+'</li>' +
            '<li><em>房源特色：</em>'+_ite.characteristic_name+'</li>' +
            '</ul></div>' +
            '<div class="pic"><a target="_blank" href="'+_ite.arcurl+'"><img src="'+_ite.litpic+'" width="151" height="99" alt="'+_ite.title+'"></a>' +
            '<span class="rexiao_1"></span><p class="all366C"><a target="_blank" href="'+_ite.arcurl+'">进入房源详情页>></a></p></div></div><div class="m2"></div></div></div>';
        var opts = {
